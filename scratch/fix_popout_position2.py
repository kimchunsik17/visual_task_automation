...
# Replace the entire DraggableTextarea component
content = re.sub(r'export const DraggableTextarea = \(\{ id, fieldKey, value, onChange, placeholder, isDetached \}\) => \{[\s\S]*?return isEditing \? \([\s\S]*?\);\s*\};?', new_comp, content)
