...
- regexExtractNode: {{NODE_DEFINITION}}
- textDiffNode: {{NODE_DEFINITION}}
- dataConvertNode: {{NODE_DEFINITION}}
- templateRenderNode: {{NODE_DEFINITION}}
- httpCheckNode: {{NODE_DEFINITION}}
- osvScanNode: {{NODE_DEFINITION}}
...
NodeType = Literal[
    ...
    # 백로그 34 DEV-2(2026-09-19): 개발 편의 노드 — 결정적, 외부 호출 없음(ADR-0033).
    "regexExtractNode", "textDiffNode", "dataConvertNode", "templateRenderNode",
    # DEV-2 2차(2026-09-19): 감시형 유틸 — 웹사이트 점검·OSV 취약점 검사(ADR-0034).
