...
def load_llm_settings() -> LLMSettings:
    ...
    return LLMSettings(
        ...
        models={
            ...
            "balanced": os.getenv("LLM_MODEL_BALANCED", "gpt-5.4-mini"),
            "quality": os.getenv("LLM_MODEL_QUALITY", "gpt-5.3-chat-latest"),
            "evaluation": os.getenv("LLM_MODEL_EVALUATION", "gpt-4o-mini"),
            "title": os.getenv("LLM_MODEL_TITLE", "gpt-4o-mini"),
        },
