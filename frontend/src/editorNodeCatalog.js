...
const STATIC_EDITOR_NODES = [
  ...
  ['discordTriggerNode', '디스코드 수신', 'input', '#5865f2', 'node-discord-trigger', 'trigger'],
  ['telegramTriggerNode', '텔레그램 수신', 'input', '#26a5e4', 'node-telegram-trigger', 'trigger'],
  ['youtubeTriggerNode', 'YouTube 새 영상 감지', 'input', '#ff0033', 'node-youtube', 'trigger'],
  ['valueNode', '변수', 'input', '#ec4899', 'node-value'],
  ['promptNode', '프롬프트', 'ai', '#3b82f6', 'node-prompt'],
  ['llmNode', 'LLM', 'ai', '#8b5cf6', 'node-llm'],
  ['multiAgentNode', '멀티 에이전트', 'ai', '#6366f1', 'node-multi-agent'],
  ['conditionNode', '조건 분기', 'logic', '#0ea5e9', 'node-condition'],
  ['loopNode', '반복', 'logic', '#ca8a04', 'node-loop', 'container'],
  ['breakNode', '반복 종료', 'logic', '#dc2626', 'node-break'],
  ['delayNode', '대기', 'logic', '#3b82f6', 'node-delay'],
  ['mergeNode', '병합', 'logic', '#ec4899', 'node-merge'],
  ...
  ['emailNode', '이메일 발송', 'integration', '#f43f5e', 'node-email'],
  ['kakaoNode', '카카오톡 발송', 'integration', '#facc15', 'node-kakao-alimtalk'],
  ...
  ['rssTriggerNode', 'RSS 새 글 감지', 'input', '#f97316', 'node-webhook', 'trigger'],
  ['gmailTriggerNode', 'Gmail 수신', 'input', '#ea4335', 'node-email', 'trigger'],
  ['gmailNode', 'Gmail 발송', 'integration', '#ea4335', 'node-email'],
  ['googleDriveNode', 'Google Drive', 'integration', '#34a853', 'node-file-modifier'],
  ['httpRequestNode', 'HTTP 요청', 'integration', '#0ea5e9', 'node-http-request'],
  ['naverSearchTriggerNode', '네이버 새 글 감지', 'input', '#03c75a', 'provider-naver-api-hub', 'trigger'],
  ...
  ['memoNode', '메모', 'advanced', '#eab308', 'ui-text', 'annotation'],
];
