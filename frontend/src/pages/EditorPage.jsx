...
const nodeTypes = {
  ...
  regexExtractNode: RegexExtractNode,
  ...
  gitlabTriggerNode: GitlabTriggerNode,
            ...
            {isMobileToolsDrawerOpen && (
              <div className="editor-more-menu" role="menu">
                ...
                <section className="editor-menu-section">
                  ...
                  {nodes.some(n => ['webhookNode', 'githubTriggerNode', 'gitlabTriggerNode', 'scheduleNode', 'discordNode'].includes(n.type)) && (
